...
- `monsterdb write_item [prefabName]`:
- `mosnterdb mod_item [fileName]`:
- `monsterdb clone_item [prefabName][newName]`:
- `monsterdb write_fish [prefabName]`:
- `monsterdb mod_fish [fileName]`:
- `monsterdb clone_fish [prefabName][newName]`: